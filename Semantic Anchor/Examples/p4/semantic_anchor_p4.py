#!/usr/bin/env python3
"""
Semantic Anchor Evaluator: p4
===============================

Auto-generated by semantic_anchor_generator.py

Loads anchors from: anchors_list_p4.json

Usage:
  python semantic_anchor_p4.py                       # Interactive (cosine mode)
  python semantic_anchor_p4.py --mode nli             # NLI entailment scoring
  python semantic_anchor_p4.py --mode hybrid          # Merged cosine + NLI KNN (recommended)
  python semantic_anchor_p4.py --mode llm             # LLM-as-judge scoring
  python semantic_anchor_p4.py --mode llm_few_shot    # LLM few-shot grounding
  python semantic_anchor_p4.py --compare              # Compare all modes side-by-side
  python semantic_anchor_p4.py --compare -f input.txt # Compare all modes on file
  python semantic_anchor_p4.py --verbose              # Full table
  python semantic_anchor_p4.py --show-examples        # View anchors
  python semantic_anchor_p4.py --file input.txt       # File mode (### separated)
  python semantic_anchor_p4.py --graph                # Distribution visualization
...
Scoring modes:
  ...
  llm:          LLM-as-judge. Requires config_p4.ini with provider, model, api_key.
