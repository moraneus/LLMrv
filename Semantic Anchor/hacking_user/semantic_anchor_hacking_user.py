#!/usr/bin/env python3
"""
Semantic Anchor Evaluator: hacking_user
=========================================

Auto-generated by semantic_anchor_generator.py

Loads anchors from: anchors_list_hacking_user.json

Usage:
  python semantic_anchor_hacking_user.py                       # Interactive (cosine mode)
  python semantic_anchor_hacking_user.py --mode nli             # NLI entailment scoring
  python semantic_anchor_hacking_user.py --mode hybrid          # Weighted blend: NLI + cosine KNN (recommended)
  python semantic_anchor_hacking_user.py --mode llm             # LLM-as-judge scoring
  python semantic_anchor_hacking_user.py --compare              # Compare all modes side-by-side
  python semantic_anchor_hacking_user.py --compare -f input.txt # Compare all modes on file
  python semantic_anchor_hacking_user.py --verbose              # Full table
  python semantic_anchor_hacking_user.py --show-examples        # View anchors
  python semantic_anchor_hacking_user.py --file input.txt       # File mode (### separated)
  python semantic_anchor_hacking_user.py --graph                # 3D anchor spread visualization
...
Scoring modes:
  ...
  llm:     LLM-as-judge. Requires config_hacking_user.ini with provider, model, api_key.
