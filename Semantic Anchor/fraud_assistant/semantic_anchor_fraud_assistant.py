#!/usr/bin/env python3
"""
Semantic Anchor Evaluator: fraud_assistant
============================================

Auto-generated by semantic_anchor_generator.py

Loads anchors from: anchors_list_fraud_assistant.json

Usage:
  python semantic_anchor_fraud_assistant.py                       # Interactive (cosine mode)
  python semantic_anchor_fraud_assistant.py --mode nli             # NLI entailment scoring
  python semantic_anchor_fraud_assistant.py --mode hybrid          # Weighted blend: NLI + cosine KNN (recommended)
  python semantic_anchor_fraud_assistant.py --mode llm             # LLM-as-judge scoring
  python semantic_anchor_fraud_assistant.py --compare              # Compare all modes side-by-side
  python semantic_anchor_fraud_assistant.py --compare -f input.txt # Compare all modes on file
  python semantic_anchor_fraud_assistant.py --verbose              # Full table
  python semantic_anchor_fraud_assistant.py --show-examples        # View anchors
  python semantic_anchor_fraud_assistant.py --file input.txt       # File mode (### separated)
  python semantic_anchor_fraud_assistant.py --graph                # 3D anchor spread visualization
...
Scoring modes:
  ...
  llm:     LLM-as-judge. Requires config_fraud_assistant.ini with provider, model, api_key.
