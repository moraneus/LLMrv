"""
Built-in propositions available without user creation.

These proposition IDs can be referenced directly in formulas and are
computed by the monitor at runtime.
"""
...
def is_builtin_proposition(prop_id: str) -> bool:
